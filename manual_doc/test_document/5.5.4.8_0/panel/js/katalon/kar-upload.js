            ...
            $.ajax({
                ...
                success: function () {
                    $.ajax({
                        ...
                        success: function () {
                            if (executionUrl) {
                                showTestOpsDialog('Execution logs have been uploaded successfully. Please give us a few minutes to analyze the data. Thank you!', true);
...
function showTestOpsLoginDialog(){
    const dialogHtml = `
                    ...
                    <span>When using with Katalon Recorder, Katalon TestOps also helps you backup your entire project to avoid the possibility of data loss.</span>
                    </br> 
...
function uploadLogToTestOps(){
    getProjects()
      .then(projects => {
          ...
          import("../UI/services/tracking-service/segment-tracking-service.js").then(module => {
