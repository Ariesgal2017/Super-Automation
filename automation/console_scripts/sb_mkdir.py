"""
Creates a new folder for running Super-Automation scripts.

Usage:
    automation mkdir [DIRECTORY]
    OR     sdet mkdir [DIRECTORY]

Example:
    sdet mkdir ui_tests

Output:
    Creates a new folder for running Super scripts.
...
def invalid_run_command(msg=None):
    exp = "  ** mkdir **\n\n"
    exp += "  Usage:\n"
    exp += "          automation mkdir [DIRECTORY_NAME]\n"
    exp += "          OR     sdet mkdir [DIRECTORY_NAME]\n"
    exp += "  Example:\n"
    exp += "          sdet mkdir browser_tests\n"
    exp += "  Output:\n"
    exp += "          Creates a new folder for running super scripts.\n"
...
def main():
    ...
    data.append("sdet")
    data.append("sdet*")
    data.append("super_env")
    data.append("super_venv")
    data.append("sdet_env")
    data.append("sdet_venv")
    ...
    data = []
    data.append("from automation import BaseCase")
    data.append("")
    data.append("")
    ...
    data.append('        self.switch_to_default_content()')
    data.append('        self.assert_link_text("automation.com")')
    data.append('        self.assert_link_text("SeleniumBase on GitHub")')
    data.append('        self.assert_link_text("automation.io")')
    ...
    data.append('        ["automation", "automation/SeleniumBase"],')
    data.append("    ])")
