# -*- coding: utf-8 -*-
"""
Creates a new Super-Automation test file with boilerplate code.

Usage:
    automation mkfile [FILE.py] [OPTIONS]
    or     sdet mkfile [FILE.py] [OPTIONS]

Example:
    sdet mkfile new_test.py
...
Output:
    ...
    boilerplate with the 5 most common Super-Automation
...
def invalid_run_command(msg=None):
    exp = "  ** mkfile **\n\n"
    exp += "  Usage:\n"
    exp += "          automation mkfile [FILE.py] [OPTIONS]\n"
    exp += "          OR     sdet mkfile [FILE.py] [OPTIONS]\n"
    exp += "  Example:\n"
    exp += "          sdet mkfile new_test.py\n"
    exp += "  Options:\n"
    ...
    exp += "  Output:\n"
    exp += "          Creates a new sdet test file with boilerplate code.\n"
    exp += "          If the file already exists, an error is raised.\n"
    exp += "          By default, uses English mode and creates a\n"
    exp += "          boilerplate with the 5 most common Super-Automation\n"
...
def main():
    ...
    if language != "English" and sys.version_info[0] == 2:
        print("")
        msg = 'Multi-language support for "sdet mkfile" '
    ...
    import_line = "from automation import BaseCase"
    parent_class = "BaseCase"
    class_line = "class MyTestClass(BaseCase):"
    if language != "English":
        from automation.translate.master_dict import MD_F
    ...
    if language == "English":
        ...
        from automation.translate.master_dict import MD
        from automation.translate.master_dict import MD_L_Codes
        md = MD.md
