"""
Super-Automation console scripts runner

Usage:
automation [COMMAND] [PARAMETERS]
  OR   zahed [COMMAND] [PARAMETERS]

Examples:
zahed install chromedriver
zahed mkdir ui_tests
zahed mkfile new_test.py
zahed options
zahed convert webdriver_unittest_file.py
zahed print my_first_test.py -n
zahed translate my_first_test.py --zh -p
zahed extract-objects my_first_test.py
zahed inject-objects my_first_test.py
zahed objectify my_first_test.py
zahed revert-objects my_first_test.py
zahed encrypt
zahed decrypt
zahed download server
zahed grid-hub start
zahed grid-node start --hub=127.0.0.1
"""
...
def show_usage():
    ...
    sc += ('    For info on all commands, type: "automation --help".\n')
    ...
    if "linux" not in sys.platform:
        ...
        sc = sc.replace("automation", c1 + "Super" + c2 + "automation" + cr)
        sc = sc.replace("sdet", c1 + "Super" + c2 + "Automation" + cr)
...
def show_basic_usage():
    ...
    sc += (' * (EXAMPLE: "zahed install chrome latest")  *\n')
    sc += ("")
    if "linux" not in sys.platform:
        c1 = colorama.Fore.BLUE + colorama.Back.LIGHTCYAN_EX
        c2 = colorama.Fore.BLUE + colorama.Back.LIGHTGREEN_EX
        cr = colorama.Style.RESET_ALL
        sc = sc.replace("automation", c1 + "Super" + c2 + "Automation" + cr)
        sc = sc.replace("sdet", c1 + "sd" + c2 + "et" + cr)
    print(sc)
...
def show_install_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation install [DRIVER_NAME] [OPTIONS]")
    print("           OR:    sdet install [DRIVER_NAME] [OPTIONS]")
    ...
    print("  Example:")
    print("           zahed install chrome")
    print("           zahed install gecko")
    print("           zahed install edge")
    print("           zahed install chrome 85")
    print("           zahed install chrome 85.0.4183.87")
    print("           zahed install chrome latest")
    print("           zahed install chrome -p")
    print("           zahed install chrome latest -p")
    print("           zahed install edge 85.0.564.68")
    print("  Output:")
    print("           Installs the chosen webdriver to automation/drivers/")
...
def show_mkdir_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation mkdir [DIRECTORY_NAME]")
    print("           OR:    sdet mkdir [DIRECTORY_NAME]")
    print("  Example:")
    print("           sdet mkdir browser_tests")
    print("  Output:")
    print("           Creates a new folder for running Super scripts.")
...
def show_mkfile_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation mkfile [FILE.py]")
    print("           OR:    sdet mkfile [FILE.py]")
    print("  Example:")
    print("           sdet mkfile new_test.py")
    print("  Options:")
    ...
    print("  Output:")
    print("          Creates a new Super test file with boilerplate code.")
    print("          If the file already exists, an error is raised.")
    print("          By default, uses English mode and creates a")
    print("          boilerplate with the 5 most common Super-Automation")
...
def show_convert_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation convert [WEBDRIVER_UNITTEST_FILE.py]")
    print("           OR:    sdet convert [WEBDRIVER_UNITTEST_FILE.py]")
    print("  Output:")
    print("           Converts a Selenium IDE exported WebDriver unittest")
    print("           file into a Super-Automation file. Adds _Super to the new")
...
def show_print_usage():
    ...
    print("")
    print("  Usage:")
    print("         automation print [FILE] [OPTIONS]")
    print("         OR:    sdet print [FILE] [OPTIONS]")
    print("  Options:")
...
def show_translate_usage():
    ...
    print("")
    print("  Usage:")
    print("         automation translate [SB_FILE.py] [LANGUAGE] [ACTION]")
    print("         OR:    sdet translate [SB_FILE.py] [LANGUAGE] [ACTION]")
    print("  Languages:")
    print("         --en / --English    |    --zh / --Chinese")
    print("         --nl / --Dutch      |    --fr / --French")
    print("         --it / --Italian    |    --ja / --Japanese")
    ...
    print("  Output:")
    print("         Translates a Super-Automation Python file into the language")
...
def show_extract_objects_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation extract-objects [SB_FILE.py]")
    print("           OR:    sdet extract-objects [SB_FILE.py]")
    print("  Output:")
    print("           Creates page objects based on selectors found in a")
    print("           automation Python file and saves those objects to the")
...
def show_inject_objects_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation inject-objects [SB_FILE.py]")
    print("           OR:    sdet inject-objects [SB_FILE.py]")
    print("  Options:")
    ...
    print('           the selected automation Python file.')
    print("")
...
def show_objectify_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation objectify [SB_FILE.py]")
    print("           OR:    sdet objectify [SB_FILE.py]")
    print("  Options:")
    print("           -c, --comments  (Add object selectors to the comments.)")
    print("                           (Default: No added comments.)")
    print("  Output:")
    ...
    print("")
    print('           (automation "objectify" has the same outcome as')
...
def show_revert_objects_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation revert-objects [SB_FILE.py]")
    print("           OR:    sdet revert-objects [SB_FILE.py]")
    print("  Options:")
    print("           -c, --comments  (Keep existing comments for the lines.)")
    print("                           (Default: No comments are kept.)")
    print("  Output:")
    print('           Reverts the changes made by "automation objectify" or')
    print('           "automation inject-objects" when run against a')
    print('           automation Python file. Objects will get replaced by')
...
def show_encrypt_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation encrypt   ||   automation obfuscate")
    print("                                --OR--")
    print("                  sdet encrypt   ||          sdet obfuscate")
    print("  Output:")
...
def show_decrypt_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation decrypt   ||   automation unobfuscate")
    print("                                --OR--")
...
def show_download_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation download server")
    print("           OR:    sdet download server")
    print("  Output:")
...
def show_grid_hub_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation grid-hub {start|stop|restart} [OPTIONS]")
    print("           OR:    sdet grid-hub {start|stop|restart} [OPTIONS]")
    print("  Options:")
    ...
    print("  Example:")
    print("           automation grid-hub start")
    print("  Output:")
...
def show_grid_node_usage():
    ...
    print("")
    print("  Usage:")
    print("           automation grid-node {start|stop|restart} [OPTIONS]")
    print("           OR:    sdet grid-node {start|stop|restart} [OPTIONS]")
    print("  Options:")
    ...
    print("                          (Default: Quiet logging / Not verbose.)")
    print("  Example:")
    print("           automation grid-node start --hub=127.0.0.1")
    print("  Output:")
...
def get_version_info():
    ...
    # version = get_distribution("automation").version
    ...
    c3 = colorama.Fore.BLUE + colorama.Back.LIGHTYELLOW_EX
    cr = colorama.Style.RESET_ALL
    sa_text = c1 + "Super" + c2 + "Automation" + cr
    version_info = "%s %s%s%s" % (sa_text, c3, __version__, cr)
    return version_info
...
def get_package_location():
    # from pkg_resources import get_distribution
    # location = get_distribution("automation").location
    import os
    import automation
    location = os.path.dirname(os.path.realpath(automation.__file__))
    if location.endswith("automation"):
        location = location[0:-len("automation")]
    return location
...
def show_options():
    ...
    print(sc)
    print("")
    line = "Here are some common pytest options to use with Super-Automation:"
    line = c1 + line + cr
    print(line)
    print("")
    ...
    print('--settings-file=FILE  (Override default Super-Automation settings.)')
...
def main():
    ...
    if command == "install":
        if len(command_args) >= 1:
            from automation.console_scripts import sb_install
            sb_install.main()
        else:
            show_basic_usage()
            show_install_usage()
        ...
        if len(command_args) >= 1:
            from automation.console_scripts import sb_mkdir
            sb_mkdir.main()
        else:
            show_basic_usage()
            show_mkdir_usage()
        ...
        if len(command_args) >= 1:
            from automation.console_scripts import sb_mkfile
            sb_mkfile.main()
        else:
            show_basic_usage()
            show_mkfile_usage()
        ...
        if len(command_args) == 1:
            from automation.utilities.selenium_ide import convert_ide
            convert_ide.main()
        else:
            show_basic_usage()
            show_convert_usage()
        ...
        if len(command_args) >= 1:
            if sys.version_info[0] == 2:
                ...
                cr = colorama.Style.RESET_ALL
                msg = '"Super-Automation print" does NOT support Python 2! '
                msg += 'Try using the Unix "cat" command instead!'
                message = "\n" + c5 + msg + cr + "\n"
                print("")
                raise Exception(message)
            from automation.console_scripts import sb_print
            sb_print.main()
        else:
            show_basic_usage()
            show_print_usage()
        ...
        if len(command_args) >= 1:
            if sys.version_info[0] == 2:
                c5 = colorama.Fore.RED + colorama.Back.LIGHTYELLOW_EX
                cr = colorama.Style.RESET_ALL
                msg = "The Super-Automation Translator does NOT support Python 2!"
                message = "\n" + c5 + msg + cr + "\n"
                print("")
                raise Exception(message)
            from automation.translate import translator
            translator.main()
        else:
            show_basic_usage()
            show_translate_usage()
        ...
        if len(command_args) >= 1:
            from automation.console_scripts import objectify
        ...
        if len(command_args) >= 0:
            from automation.common import obfuscate
            obfuscate.main()
        else:
            show_basic_usage()
            show_encrypt_usage()
        ...
        if len(command_args) >= 0:
            from automation.common import unobfuscate
            unobfuscate.main()
        else:
            show_basic_usage()
            show_decrypt_usage()
        ...
        if len(command_args) >= 1 and command_args[0].lower() == "server":
            from automation.utilities.selenium_grid import (
        ...
        if len(command_args) >= 1:
            from automation.utilities.selenium_grid import grid_hub
            grid_hub.main()
        else:
            show_basic_usage()
            show_grid_hub_usage()
        ...
        if len(command_args) >= 1:
            from automation.utilities.selenium_grid import grid_node
            grid_node.main()
        else:
            show_basic_usage()
            show_grid_node_usage()
