...
from automation.config import proxy_list
from automation.config import settings
from automation.core import download_helper
from automation.core import proxy_helper
...
from automation import extensions  # browser extensions storage folder
...
if not os.environ["PATH"].startswith(DRIVER_DIR):
    # Remove existing Super-Automation DRIVER_DIR from System PATH if present
    ...
    # Put the Super-Automation DRIVER_DIR at the beginning of the System PATH
...
if "darwin" in PLATFORM or "linux" in PLATFORM:
    ...
    pass  # Super-Automation will use web drivers from the System PATH by default
...
def display_proxy_warning(proxy_string):
    message = ('\n\nWARNING: Proxy String ["%s"] is NOT in the expected '
               ...
               'automation.config.proxy_list.PROXY_LIST).'
               % proxy_string)
...
def get_remote_driver(
    ...
    extra_caps = {}
    if cap_file:
        from automation.core import capabilities_parser
            ...
            if not headless or "linux" not in PLATFORM:
                ...
                try:
                    ...
                    logging.debug("\nWarning: Chrome failed to launch in"
                                  ...
                                  " Super-Automation virtual display on Linux...")
