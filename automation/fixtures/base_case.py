# -*- coding: utf-8 -*-
"""
The BaseCase class is the main gateway for using The Super-Automation Framework.
...
Usage:
    ...
    class MyTestClass(BaseCase):
        def test_anything(self):
            ...
            self.type("input.header-search-input", "Super-Automation\n")
            self.click('a[href="/automation/Super-Automation"]')
            self.assert_element("div.repository-content")
            ....

Super-Automation methods expand and improve on existing WebDriver commands.
...
from automation import config as sb_config
from automation.common import decorators
from automation.config import settings
from automation.core import log_helper
from automation.core import tour_helper
from automation.fixtures import constants
from automation.fixtures import css_to_xpath
from automation.fixtures import js_utils
from automation.fixtures import page_actions
from automation.fixtures import page_utils
from automation.fixtures import shared_utils
from automation.fixtures import xpath_to_css
...
class BaseCase(unittest.TestCase):
    ...
    def hover_on_element(self, selector, by=By.CSS_SELECTOR):
        ...
        try:
            ...
            install_sb = (
                    "automation install chromedriver %s" % major_chrome_version)
    ...
    def get_new_driver(self, browser=None, headless=None, locale_code=None,
        ...
        """ This method spins up an extra browser for tests that require
            ...
            that import base_case.BaseCase from automation. If parameters
        ...
        if self.browser == "remote" and not (self.cap_file or self.cap_string):
            raise Exception('Need to specify a desired capabilities file when '
                            ...
                            '%s OR '
                            '%s '
                            'See Super-Automation/examples/sample_cap_file_BS.py '
                            'and Super-Automation/examples/sample_cap_file_SL.py'
        ...
        from automation.core import browser_launcher
    ...
    def ad_block(self):
        ...
        from automation.config import ad_block_list
    ...
    def assert_no_404_errors(self, multithreaded=True):
        ...
        if self.demo_mode:
            ...
            if self._language != "English":
                from automation.fixtures.words import SD
    ...
    def get_downloads_folder(self):
        ...
        from automation.core import download_helper
        ...
        for entry in browser_logs:
            if entry['level'] == 'SEVERE':
                if messenger_library not in entry['message']:
                    # Add errors if not caused by Super-Automation dependencies
                    errors.append(entry)
        if len(errors) > 0:
            current_url = self.get_current_url()
            raise Exception(
    ...
    def get_google_auth_password(self, totp_key=None):
        """ Returns a time-based one-time password based on the
            ...
            provided in automation/config/settings.py
    ...
    def create_presentation(
        ...
        new_presentation = (
                ...
                '</head>\n\n'
                '<body>\n'
                '<!-- Generated by Super-Automation - https://seleniumbase.io -->\n'
                '<div class="reveal">\n'
                '<div class="slides">\n'
    ...
    def add_data_point(self, label, value, color=None, chart_name=None):
        """ Add a data point to a Super-Automation-generated chart.
            @Params
    ...
    def save_chart(self, chart_name=None, filename=None):
        """ Saves a Super-Automation-generated chart to a file for later use.
            @Params
    ...
    def display_chart(self, chart_name=None, filename=None, interval=0):
        """ Displays a Super-Automation-generated chart in the browser window.
            @Params
            chart_name - If creating multiple charts at the same time,
                         use this to select the one you wish to use.
            filename - The name of the HTML file that you wish to
    ...
    def extract_chart(self, chart_name=None):
        """ Extracts the HTML from a Super-Automation-generated chart.
            @Params
            chart_name - If creating multiple charts at the same time,
                         use this to select the one you wish to use.
        """
    ...
    def export_tour(self, name=None, filename="my_tour.js", url=None):
        """ Exports a tour as a JS file.
            ...
            any web browser to play the tour outside of Super-Automation runs.
            @Params
            name - If creating multiple tours at the same time,
                   use this to select the tour you wish to add steps to.
    ...
    def check_window(self, name="default", level=0, baseline=False):
        """ ***  Automated Visual Testing with Super-Automation  ***
            ...
            * level=3 ->
            ...
            better off using regular Super-Automation functional testing.
        ...
        if not name or len(name) < 1:
            name = "default"
        name = str(name)
        from automation.core import visual_helper
    ...
    def __get_improved_exception_message(self):
        ...
        if self.browser == 'chrome' and maybe_using_old_chromedriver:
            update = ("Your version of ChromeDriver may be out-of-date! "
                      ...
                      "Or use: ``automation install chromedriver`` . "
    ...
    def setUp(self, masterqa_mode=False):
        ...
        if self.is_pytest:
            ...
            if self.with_db_reporting:
                import getpass
                import uuid
                from automation.core.application_manager import (
                    ApplicationManager)
                from automation.core.testcase_manager import (
            ...
            if self.headless:
                ...
                try:
                    ...
                    from automation.virtual_display.display import Display
        ...
        # Verify that Super-Automation is installed successfully
        if not hasattr(self, "browser"):
            raise Exception("""Super-Automation plugins DID NOT load!\n\n"""
                            """*** Please REINSTALL Super-Automation using: >\n"""
                            """    >>> "pip install -r requirements.txt"\n"""
                            """    >>> "python setup.py install" """)

        # Parse the settings file
        if self.settings_file:
            from automation.core import settings_parser
    ...
    def __insert_test_result(self, state, err):
        from automation.core.testcase_manager import TestcaseDataPayload
        data_payload = TestcaseDataPayload()
    ...
    def tearDown(self):
        ...
        try:
            ...
            message = ("You're overriding Super-Automation's BaseCase setUp() "
                       "method with your own setUp() method, which breaks "
                       "Super-Automation. You can fix this by going to your "
