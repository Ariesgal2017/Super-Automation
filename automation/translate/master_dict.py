...
class MD_F:
    ...
    def get_parent_classes_list():
        ...
        parent_classes.append("ТеѝтНаСелен")
    ...
    def get_masterqa_parent_classes_list():
        ...
        parent_classes.append("MasterQA_Руѝѝкий")
    ...
    def get_parent_class_lang(parent_class):
        ...
        parent_class_lang["ТеѝтНаСелен"] = "Russian"
    ...
    def get_mqa_par_class_lang(parent_class):
        ...
        parent_class_lang["MasterQA_Руѝѝкий"] = "Russian"
    ...
    def get_lang_parent_class(language):
        ...
        lang_parent_class["Russian"] = "ТеѝтНаСелен"
    ...
    def get_mqa_lang_par_class(language):
        ...
        lang_parent_class["Russian"] = "MasterQA_Руѝѝкий"
    ...
    def get_import_line(language):
        ...
        import_line["Chinese"] = (
            "from automation.translate.chinese import 硒测试用例")
        import_line["Dutch"] = (
            "from automation.translate.dutch import Testgeval")
        import_line["French"] = (
            "from automation.translate.french import CasDeBase")
        import_line["Italian"] = (
            "from automation.translate.italian import CasoDiProva")
        import_line["Japanese"] = (
            "from automation.translate.japanese import セレニウムテストケース")
        import_line["Korean"] = (
            "from automation.translate.korean import 셀레늄_테스트_케이스")
        import_line["Portuguese"] = (
            "from automation.translate.portuguese import CasoDeTeste")
        import_line["Russian"] = (
            "from automation.translate.russian import ТеѝтНаСелен")
        import_line["Spanish"] = (
            "from automation.translate.spanish import CasoDePrueba")
    ...
    def get_mqa_im_line(language):
        ...
        # - Translated Import Lines:
        import_line["Chinese"] = (
            "from automation.translate.chinese import MasterQA_中文")
        import_line["Dutch"] = (
            "from automation.translate.dutch import MasterQA_Nederlands")
        import_line["French"] = (
            "from automation.translate.french import MasterQA_Français")
        import_line["Italian"] = (
            "from automation.translate.italian import MasterQA_Italiano")
        import_line["Japanese"] = (
            "from automation.translate.japanese import MasterQA_日本語")
        import_line["Korean"] = (
            "from automation.translate.korean import MasterQA_한국어")
        import_line["Portuguese"] = (
            "from automation.translate.portuguese import MasterQA_Português")
        import_line["Russian"] = (
            "from automation.translate.russian import MasterQA_Руѝѝкий")
        import_line["Spanish"] = (
            "from automation.translate.spanish import MasterQA_Español")
        if language not in import_line.keys():
            raise Exception("Invalid language {%s} not in {%s}!"
                            "" % (language, import_line.keys()))
        return import_line[language]
...
class MD:
    ...
    md["slow_click"][5] = "ゆ㝣㝝りクリック㝗㝦"
    md["slow_click"][6] = "천천히_흴릭"
    ...
    md["click_link_text"][5] = "リンクテキストをクリック㝗㝾㝙"
    md["click_link_text"][6] = "망희_텝스트를_흴릭합니다"
    md["click_link_text"][7] = "clique_texto_do_link"
    md["click_link_text"][8] = "нажмите_ѝѝылку"
    ...
    md["update_text"][6] = "텝스트를_업띰이트"
    md["update_text"][7] = "atualizar_texto"
    md["update_text"][8] = "обновить_текѝт"
    ...
    md["add_text"][6] = "텝스트를_추가"
    md["add_text"][7] = "adicionar_texto"
    md["add_text"][8] = "добавить_текѝт"
    ...
    md["get_text"][5] = "テキストを坖得"
    md["get_text"][6] = "텝스트를_검색"
    md["get_text"][7] = "obter_texto"
    md["get_text"][8] = "получить_текѝт"
    ...
    md["assert_text"][5] = "テキストを確誝㝙る"
    md["assert_text"][6] = "텝스트_확인"
    md["assert_text"][7] = "verificar_texto"
    md["assert_text"][8] = "подтвердить_текѝт"
    ...
    md["assert_exact_text"][5] = "正確㝪テキストを確誝㝙る"
    md["assert_exact_text"][6] = "정확한_텝스트를_확인하는"
    md["assert_exact_text"][7] = "verificar_texto_exato"
    md["assert_exact_text"][8] = "подтвердить_текѝт_точно"
    ...
    md["assert_link_text"][5] = "リンクテキストを確誝㝙る"
    md["assert_link_text"][6] = "망희_텝스트_확인"
    md["assert_link_text"][7] = "verificar_texto_do_link"
    md["assert_link_text"][8] = "подтвердить_ѝѝылку"
    ...
    md["assert_element"][5] = "覝素を確誝㝙る"
    md["assert_element"][6] = "요소_확인"
    md["assert_element"][7] = "verificar_elemento"
    md["assert_element"][8] = "подтвердить_ѝлемент"
    ...
    md["assert_element_visible"][1] = "断言元素坯觝"
    ...
    md["assert_element_visible"][5] = "覝素㝌表示㝕れ㝦㝄る㝓㝨を確誝"
    md["assert_element_visible"][6] = "요소가_보이는지_확인"
    md["assert_element_visible"][7] = "verificar_elemento_visível"
    md["assert_element_visible"][8] = "подтвердить_ѝлемент_виден"
    ...
    md["assert_element_not_visible"][1] = "断言元素丝坯觝"
    ...
    md["assert_element_not_visible"][5] = "覝素㝌表示㝕れ㝦㝄㝪㝄㝓㝨を確誝㝗㝾㝙"
    md["assert_element_not_visible"][6] = "요소가_보이지_않는지_확인"
    md["assert_element_not_visible"][7] = "verificar_elemento_não_visível"
    md["assert_element_not_visible"][8] = "подтвердить_ѝлемент_не_виден"
    ...
    md["assert_element_present"][5] = "覝素㝌存在㝙る㝓㝨を確誝㝗㝾㝙"
    md["assert_element_present"][6] = "요소가_존재하는지_확인"
    md["assert_element_present"][7] = "verificar_elemento_presente"
    md["assert_element_present"][8] = "подтвердить_ѝлемент_приѝутѝтвует"
    ...
    md["assert_element_absent"][1] = "断言元素丝存在"
    ...
    md["assert_element_absent"][5] = "覝素㝌存在㝗㝪㝄㝓㝨を確誝㝗㝾㝙"
    md["assert_element_absent"][6] = "요소가_존재하지_않는지_확인"
    md["assert_element_absent"][7] = "verificar_elemento_ausente"
    md["assert_element_absent"][8] = "подтвердить_ѝлемент_отѝутѝтвует"
    ...
    md["assert_equal"][5] = "検証㝌等㝗㝄"
    md["assert_equal"][6] = "띙일한지_확인"
    ...
    md["assert_not_equal"][5] = "検証㝌等㝗㝝㝪㝄"
    md["assert_not_equal"][6] = "띙일하지_않다고_어설션"
    ...
    md["get_current_url"][5] = "睾在㝮URLを坖得"
    ...
    md["get_page_source"][5] = "ページ㝮ソースコードを坖得㝙る"
    md["get_page_source"][6] = "페이지의_소스_코드를_얻을"
    md["get_page_source"][7] = "obter_a_página_html"
    md["get_page_source"][8] = "получить_иѝточник_ѝтраницы"
    ...
    md["wait_for_text"][5] = "テキストを待㝤"
    md["wait_for_text"][6] = "텝스트가_나타날_때까지_기다립니다"
    md["wait_for_text"][7] = "aguardar_o_texto"
    md["wait_for_text"][8] = "ждать_текѝта"
    ...
    md["wait_for_element_visible"][1] = "等待元素坯觝"
    ...
    md["wait_for_element_visible"][5] = "覝素㝌表示㝕れる㝮を待㝡㝾㝙"
    md["wait_for_element_visible"][6] = "요소가_표시_띠_때까지_기다립니다"
    md["wait_for_element_visible"][7] = "aguardar_o_elemento_visível"
    md["wait_for_element_visible"][8] = "ждать_ѝлемента_виден"
    ...
    md["wait_for_element_not_visible"][1] = "等待元素丝坯觝"
    ...
    md["wait_for_element_absent"][1] = "等待元素丝存在"
    ...
    md["js_update_text"][6] = "JS_텝스트를_업띰이트"
    md["js_update_text"][7] = "js_atualizar_texto"
    md["js_update_text"][8] = "JS_обновить_текѝт"
    ...
    md["save_screenshot"][6] = "스희린_샷_저장"
    md["save_screenshot"][7] = "salvar_captura_de_tela"
    md["save_screenshot"][8] = "ѝохранить_ѝкриншот"
    ...
    md["execute_script"][5] = "スクリプトを実行㝙る"
    md["execute_script"][6] = "스희립트를_실행하려면"
    md["execute_script"][7] = "executar_script"
    md["execute_script"][8] = "выполнение_ѝкрипта"
    ...
    md["safe_execute_script"][5] = "スクリプトを安全㝫実行㝙る"
    md["safe_execute_script"][6] = "스희립트를_안전하게_실행"
    md["safe_execute_script"][7] = "executar_script_com_segurança"
    md["safe_execute_script"][8] = "безопаѝное_выполнение_ѝкрипта"
    ...
    md["activate_jquery"][5] = "JQUERYを読㝿込む"
    ...
    md["assert_no_404_errors"][5] = "リンク切れを確誝㝙る"
    md["assert_no_404_errors"][6] = "띊어진_망희_확인"
    ...
    md["assert_no_js_errors"][5] = "JSエラーを確誝㝙る"
    ...
    md["switch_to_default_content"][1] = "切杢到默认内容"
    ...
    md["switch_to_default_content"][5] = "デフォルト㝮コンテンツ㝫切り替㝈る"
    md["switch_to_default_content"][6] = "기본_콘텝츠로_전환"
    md["switch_to_default_content"][7] = "mudar_para_o_conteúdo_padrão"
    md["switch_to_default_content"][8] = (
        "переключитьѝѝ_на_ѝодержимое_по_умолчанию")
    ...
    md["open_new_window"][5] = "新㝗㝄ウィンドウを開㝝"
    ...
    md["switch_to_window"][5] = "ウィンドウ㝫切り替㝈"
    md["switch_to_window"][6] = "창으로_전환"
    md["switch_to_window"][7] = "mudar_para_janela"
    md["switch_to_window"][8] = "переключитьѝѝ_на_окно"
    ...
    md["switch_to_default_window"][1] = "切杢到默认窗坣"
    ...
    md["switch_to_default_window"][5] = "デフォルト㝮ウィンドウ㝫切り替㝈る"
    md["switch_to_default_window"][6] = "기본_창으로_전환"
    md["switch_to_default_window"][7] = "mudar_para_a_janela_padrão"
    md["switch_to_default_window"][8] = "переключитьѝѝ_в_окно_по_умолчанию"
    ...
    md["maximize_window"][5] = "ウィンドウを最大化㝙る"
    md["maximize_window"][6] = "창_최대화"
    md["maximize_window"][7] = "maximizar_janela"
    md["maximize_window"][8] = "макѝимальное_окно"
    ...
    md["scroll_to"][5] = "スクロール㝗㝦"
    md["scroll_to"][6] = "요소로_스희롤"
    ...
    md["scroll_to_top"][5] = "一番上㝾㝧スクロール"
    md["scroll_to_top"][6] = "맨_위로_스희롤"
    md["scroll_to_top"][7] = "rolar_para_o_topo"
    md["scroll_to_top"][8] = "пролиѝтать_наверх"
    ...
    md["scroll_to_bottom"][5] = "一番下㝾㝧スクロール"
    md["scroll_to_bottom"][6] = "하단으로_스희롤"
    ...
    md["hover_and_click"][5] = "上㝫マウスを移動㝗クリック"
    md["hover_and_click"][6] = "위로_마우스를_이띙하고_흴릭"
    ...
    md["click_visible_elements"][1] = "坕击坯觝元素"
    ...
    md["click_visible_elements"][5] = "表示覝素をクリック㝗㝾㝙"
    md["click_visible_elements"][6] = "페이지_요소를_흴릭_합니다"
    md["click_visible_elements"][7] = "clique_nos_elementos_visíveis"
    md["click_visible_elements"][8] = "нажмите_видимые_ѝлементы"
    ...
    md["select_option_by_text"][5] = "テキスト㝧オプションを靸択"
    md["select_option_by_text"][6] = "텝스트로_옵션_선택"
    md["select_option_by_text"][7] = "selecionar_opção_por_texto"
    md["select_option_by_text"][8] = "выбрать_опцию_по_текѝту"
    ...
    md["select_option_by_index"][5] = "インデックス㝧オプションを靸択"
    md["select_option_by_index"][6] = "인띱스별로_옵션_선택"
    md["select_option_by_index"][7] = "selecionar_opção_por_índice"
    md["select_option_by_index"][8] = "выбрать_опцию_по_индекѝу"
    ...
    md["select_option_by_value"][5] = "値㝧オプションを靸択"
    ...
    md["save_presentation"][5] = "プレゼンテーションを保存㝙る"
    md["save_presentation"][6] = "프레젠테이션_저장"
    md["save_presentation"][7] = "salvar_apresentação"
    md["save_presentation"][8] = "ѝохранить_презентацию"
    ...
    md["begin_presentation"][5] = "プレゼンテーションを開始㝙る"
    ...
    md["create_pie_chart"][5] = "円グラフを作戝㝙る"
    md["create_pie_chart"][6] = "웝형_차트_만들기"
    md["create_pie_chart"][7] = "criar_um_gráfico_de_pizza"
    md["create_pie_chart"][8] = "ѝоздать_круговую_диаграмму"
    ...
    md["create_column_chart"][5] = "縦棒グラフを作戝㝙る"
    md["create_column_chart"][6] = "열_차트_만들기"
    md["create_column_chart"][7] = "criar_um_gráfico_de_colunas"
    md["create_column_chart"][8] = "ѝоздать_ѝтолбчатую_диаграмму"
    ...
    md["create_line_chart"][5] = "折れ線グラフを作戝㝙る"
    md["create_line_chart"][6] = "선_차트_만들기"
    md["create_line_chart"][7] = "criar_um_gráfico_de_linhas"
    md["create_line_chart"][8] = "ѝоздать_линейную_диаграмму"
    ...
    md["create_area_chart"][5] = "面グラフを作戝㝙る"
    md["create_area_chart"][6] = "옝역_차트_만들기"
    md["create_area_chart"][7] = "criar_um_gráfico_de_área"
    md["create_area_chart"][8] = "ѝоздать_диаграмму_облаѝти"
    ...
    md["add_data_point"][5] = "データポイントを追加㝙る"
    md["add_data_point"][6] = "띰이터_희인트_추가"
    ...
    md["save_chart"][5] = "グラフを保存㝙る"
    md["save_chart"][6] = "차트_저장"
    md["save_chart"][7] = "salvar_gráfico"
    md["save_chart"][8] = "ѝохранить_диаграмму"
    ...
    md["add_tour_step"][5] = "ツアーステップを追加㝙る"
    ...
    md["assert_pdf_text"][5] = "PDFテキストを確誝㝙る"
    md["assert_pdf_text"][6] = "PDF_텝스트_확인"
    md["assert_pdf_text"][7] = "verificar_texto_pdf"
    md["assert_pdf_text"][8] = "подтвердить_текѝт_PDF"
    ...
    md["assert_downloaded_file"][5] = "ダウンロード㝗㝟ファイルを確誝㝙る"
    ...
    md["remove_elements"][5] = "㝙㝹㝦㝮覝素を削除"
    md["remove_elements"][6] = "모든_요소_제거"
    md["remove_elements"][7] = "remover_elementos"
    md["remove_elements"][8] = "удалить_ѝлементы"
    ...
    md["find_text"][5] = "テキストを見㝤㝑る"
    md["find_text"][6] = "텝스트_찾기"
    md["find_text"][7] = "encontrar_texto"
    md["find_text"][8] = "найти_текѝт"
    ...
    md["set_messenger_theme"][1] = "设置消杯主题"
    ...
    md["deferred_assert_element"][5] = "を延期㝙る覝素を確誝㝙る"
    md["deferred_assert_element"][6] = "연기띜_요소_확인"
    md["deferred_assert_element"][7] = "adiada_verificar_elemento"
    md["deferred_assert_element"][8] = "отложенный_подтвердить_ѝлемент"
    ...
    md["deferred_assert_text"][5] = "を延期㝙るテキストを確誝㝙る"
    md["deferred_assert_text"][6] = "연기띜_텝스트_확인"
    md["deferred_assert_text"][7] = "adiada_verificar_texto"
    md["deferred_assert_text"][8] = "отложенный_подтвердить_текѝт"
    ...
    md["process_deferred_asserts"][1] = "处睆推迟断言"
    ...
    md["process_deferred_asserts"][5] = "靅延アサーション㝮処睆"
    md["process_deferred_asserts"][6] = "연기띜_검증_처리"
    ...
    md["switch_to_alert"][5] = "アラート㝫切り替㝈"
    md["switch_to_alert"][6] = "경고로_전환"
    md["switch_to_alert"][7] = "mudar_para_alerta"
    md["switch_to_alert"][8] = "переключитьѝѝ_на_оповещение"
    ...
    md["load_html_file"][5] = "HTMLファイルを読㝿込む"
    ...
    md["open_html_file"][5] = "HTMLファイルを開㝝"
    ...
    md["send_keys"][6] = "텝스트를_추가"
    md["send_keys"][7] = "adicionar_texto"
    md["send_keys"][8] = "добавить_текѝт"
    ...
    md["set_attribute_all"][5] = "㝙㝹㝦㝮属性を設定"
    ...
    md["wait_for_text_visible"][5] = "テキストを待㝤"
    md["wait_for_text_visible"][6] = "텝스트가_나타날_때까지_기다립니다"
    md["wait_for_text_visible"][7] = "aguardar_o_texto"
    md["wait_for_text_visible"][8] = "ждать_текѝта"
    ...
    md["assert_text_visible"][5] = "テキストを確誝㝙る"
    md["assert_text_visible"][6] = "텝스트_확인"
    md["assert_text_visible"][7] = "verificar_texto"
    md["assert_text_visible"][8] = "подтвердить_текѝт"
    ...
    md["assert_no_broken_links"][5] = "リンク切れを確誝㝙る"
    md["assert_no_broken_links"][6] = "띊어진_망희_확인"
    ...
    md["wait_for_and_accept_alert"][1] = "接块警报"
    ...
    md["wait_for_and_accept_alert"][5] = "アラートを块㝑入れる"
    md["wait_for_and_accept_alert"][6] = "경고를_수락"
    md["wait_for_and_accept_alert"][7] = "aceitar_alerta"
    md["wait_for_and_accept_alert"][8] = "принѝть_оповещение"
    ...
    md["wait_for_and_dismiss_alert"][5] = "アラートを坴下"
    md["wait_for_and_dismiss_alert"][6] = "경고를_거부"
    md["wait_for_and_dismiss_alert"][7] = "demitir_alerta"
    md["wait_for_and_dismiss_alert"][8] = "увольнѝть_оповещение"
    ...
    md["wait_for_and_switch_to_alert"][1] = "切杢到警报"
    ...
    md["wait_for_and_switch_to_alert"][5] = "アラート㝫切り替㝈"
    md["wait_for_and_switch_to_alert"][6] = "경고로_전환"
    md["wait_for_and_switch_to_alert"][7] = "mudar_para_alerta"
    md["wait_for_and_switch_to_alert"][8] = "переключитьѝѝ_на_оповещение"
