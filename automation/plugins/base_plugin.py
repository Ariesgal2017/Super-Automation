...
from automation.core import report_helper
from automation.fixtures import constants, errors
    ...
    def options(self, parser, env):
        ...
        parser.add_option(
            ...
            help="""The file that stores key/value pairs for overriding
                    values in the Super-Automation settings.py file.""")
        parser.add_option(
            '--log_path', '--log-path',
            dest='log_path',
            default='latest_logs/',
        ...
        if found_timeout_arg:
            ...
            print("  Use --time-limit=s from Super-Automation instead!\n")
            parser.add_option(
                '--timeout',
                dest='timeout',
                default=0,
