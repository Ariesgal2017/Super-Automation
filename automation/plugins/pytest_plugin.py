...
def pytest_addoption(parser):
    ...
    s_str = "Super-Automation"
    s_str = s_str.replace("Super-Automation", c1 + "Super" + c2 + "Automation" + cr)
    s_str = s_str + cr + " " + c3 + "command-line options for pytest" + cr
    parser = parser.getgroup('Super-Automation', s_str)
    ...
    parser.addoption('--settings_file', '--settings-file', '--settings',
                     ...
                     help="""The file that stores key/value pairs for
                          ...
                          automation/config/settings.py file.""")
    ...
    parser.addoption('--disable_csp', '--disable-csp', '--no_csp', '--no-csp',
                     ...
                     help="""Using this disables the Content Security Policy of
                          ...
                          Super-Automation, such as loading custom JavaScript
                          libraries for various testing actions.
                          Setting this to True (--disable-csp) overrides the
                          value set in automation/config/settings.py""")
    ...
    for arg in sys.argv:
        if "--timeout=" in arg:
            raise Exception(
                ...
                "\n  Use --time-limit=s from Super-Automation instead!\n")
